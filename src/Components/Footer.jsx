...
<footer class="bg-gray-900  shadow m-4 dark:bg-gray-800">
    <div class="w-full mx-auto max-w-screen-xl p-4 mt-3 md:flex md:items-center md:justify-between">
    ...
    <ul class="flex flex-wrap items-center text-sm font-medium text-white dark:text-gray-400 sm:mt-0">
        <li>
